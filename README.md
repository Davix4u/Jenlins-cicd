# Loreon Learning — Deploy a Java Application on AWS 3-Tier Architecture
...
```bash
# Clone repository
git clone https://github.com/loreon-learning/your-repo.git
...
## About Loreon Learning

This project is maintained by **Loreon Learning** as part of the DevOps Bootcamp curriculum.
It is used to teach students real-world cloud deployment, infrastructure-as-code, and CI/CD workflows.
